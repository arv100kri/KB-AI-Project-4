...
4. Since Problems 11 and 12 are not yet released, empty placeholder directories are kept under the
"Representations" sub-directory.
5. The answers to 11 and 12 will be printed as None.
6. The project needs a little time (a few seconds) to begin since the libraries need to be initialized but the program runs normally after.
...
3. Generated_Propositional_Representations - directory which contains the simple propositions extracted out of the visual representations
